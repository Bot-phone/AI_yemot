...
שאל שאלה אחת ממוקדת רק כאשר בלעדיה השינוי יהיה שגוי ולא רק חלקי: יעד ניתוב שאינו ידוע, כתובת מייל או מספר טלפון, או בחירה בין שני מודולים שונים מהותית.
...
סיים כשכל מה שהתבקש נרשם: שורות סיכום קצרות של השינויים שנרשמו, ואחריהן מה נדרש מהמשתמש - קבצי שמע להעלאה או החלטות שנותרו פתוחות.";
