...
export const LOCALES = {
  he: {
    ...
    strings: {
      ...
      update_portable: "🚀 עדכון זמין: v{version} — הורד את הקובץ הנייד",
      ...
      mode_script_hint: "המשימה נשלחת לשרת מתווך (Google Apps Script) שפונה ל-AI במקומך. פעולות מול ימות המשיח מבוצעות תמיד מקומית.",
      relay_sent_title: "מה נשלח לשרת המתווך",
      relay_sent_task: "טקסט המשימה שכתבת",
      relay_sent_model: "סוג המודל שנבחר (רגיל / Pro)",
      relay_sent_preview: "האם ביקשת תצוגה מקדימה של הפעולות",
      relay_sent_key: "מפתח ה-API האישי, אם הזנת אחד",
      relay_not_sent_title: "מה לא נשלח",
      relay_not_sent_token: "טוקן ימות המשיח נשאר במחשב זה בלבד",
      relay_not_sent_line: "מבנה הקו, תוכן השלוחות וקבצים אינם נשלחים",
      relay_key_warning_title: "אזהרה:",
      relay_key_warning: "מפתח ה-API האישי נשלח לשרת של מפתח הסקריפט ומשמש שם לפניות ל-AI. הזן מפתח רק אם אתה סומך על מפעיל השרת; אחרת השאר ריק וייעשה שימוש במפתח המוגדר בסקריפט.",
      mode_script: "🌐 שרת מתווך",
      ...
      login_btn: "התחברות",
      token_step_title: "התחברות באמצעות טוקן",
      token_step_desc: "הדבק את טוקן המערכת של ימות המשיח. אין לך טוקן? אפשר ליצור אחד עם מספר המערכת והסיסמה.",
      token_login_btn: "התחבר עם הטוקן",
      create_token_link: "אין לי טוקן — יצירה עם מספר מערכת וסיסמה",
      have_token_link: "יש לי טוקן — הזנה ישירה",
      ...
      api_key_hint_script: "אופציונלי — נשלח לשרת המתווך. ללא מפתח ייעשה שימוש במפתח המוגדר בסקריפט (חובה למודל Pro)",
      api_key_required: "נדרש מפתח API אישי במצב ספק AI ישיר",
      api_key_placeholder: "הזן מפתח API...",
      script_url_label: "כתובת השרת המתווך (Google Apps Script)",
      script_url_default_hint: "משתמש בשרת המתווך של המפתח (ברירת מחדל). ניתן להזין כתובת של פריסה משלך.",
      script_url_custom_hint: "כתובת מותאמת אישית. שדה ריק חוזר לברירת המחדל.",
      script_url_reset: "שחזר ברירת מחדל",
      ...
      mfa_code_placeholder: "קוד בן 6 ספרות",
      cancel: "ביטול",
      ...
      enter_mfa_code: "נא להזין קוד אימות בן 6 ספרות",
      ...
      history_title: "היסטוריית משימות",
      history_refresh: "רענן",
      history_search: "סינון משימות…",
      history_empty: "אין משימות שמורות",
      history_no_matches: "אין משימות התואמות לסינון",
      history_untitled: "משימה ללא כותרת",
      history_steps: "{count} שלבים",
      history_one_step: "שלב אחד",
      history_cost: "≈ ${cost}",
      history_status_ok: "הושלם",
      history_status_failed: "נכשל",
      history_status_cancelled: "בוטל",
      history_continue: "המשך משימה",
      history_not_resumable: "לא נשמר תמליל למשימה זו — לא ניתן להמשיך אותה",
      history_delete: "מחק",
      history_clear_all: "נקה הכל",
      history_clear_confirm: "לנקות את כל ההיסטוריה?",
      history_loaded_chip: "נטענה",
      history_loaded_notice: "משימה שנטענה מההיסטוריה. ההצעות הקודמות מוצגות לקריאה בלבד — כדי לשנות משהו, המשך את המשימה למטה.",
      history_readonly_hint: "הצעות מהמשימה השמורה — לקריאה בלבד",
      history_error: "טעינת היסטוריית המשימות נכשלה: {error}",
      history_unavailable: "היסטוריית המשימות אינה זמינה בגרסה זו",
      history_load_failed: "טעינת המשימה השמורה נכשלה: {error}",
      save_history_label: "שמור היסטוריית משימות במחשב זה",
      save_history_hint: "המשימות נשמרות בקובץ מקומי במחשב זה בלבד, כדי שאפשר יהיה להמשיך אותן גם אחרי סגירת התוכנה. ללא סימון — לא נשמרת היסטוריה.",
  ...
  en: {
    ...
    strings: {
      ...
      update_portable: "🚀 Update available: v{version} — download the portable file",
      ...
      mode_script_hint: "The task is sent to a relay server (Google Apps Script) that calls the AI on your behalf. Yemot actions always run locally.",
      relay_sent_title: "What is sent to the relay server",
      relay_sent_task: "The task text you wrote",
      relay_sent_model: "The selected model type (regular / Pro)",
      relay_sent_preview: "Whether you asked for an action preview",
      relay_sent_key: "Your personal API key, if you entered one",
      relay_not_sent_title: "What is not sent",
      relay_not_sent_token: "The Yemot token never leaves this computer",
      relay_not_sent_line: "Line structure, extension contents and files are not sent",
      relay_key_warning_title: "Warning:",
      relay_key_warning: "Your personal API key is sent to the script developer's server and used there for AI calls. Enter a key only if you trust the server operator; otherwise leave it empty and the key configured in the script is used.",
      mode_script: "🌐 Relay server",
      ...
      login_btn: "Log in",
      token_step_title: "Sign in with a token",
      token_step_desc: "Paste your Yemot HaMashiach system token. No token yet? Create one with the system number and password.",
      token_login_btn: "Sign in with token",
      create_token_link: "I have no token — create one with system number and password",
      have_token_link: "I have a token — enter it directly",
      ...
      api_key_hint_script: "Optional — sent to the relay server. Without it the script's configured key is used (required for Pro model)",
      api_key_required: "A personal API key is required in direct AI provider mode",
      api_key_placeholder: "Enter API key...",
      script_url_label: "Relay server URL (Google Apps Script)",
      script_url_default_hint: "Using the developer's relay server (default). You can enter the URL of your own deployment.",
      script_url_custom_hint: "Custom URL. An empty field returns to the default.",
      script_url_reset: "Restore default",
      ...
      enter_mfa_code: "Please enter the 6-digit verification code",
      ...
      history_search: "Filter tasks…",
      history_empty: "No saved tasks",
      history_no_matches: "No tasks match the filter",
      history_untitled: "Untitled task",
      history_steps: "{count} steps",
      history_one_step: "1 step",
      history_cost: "≈ ${cost}",
      history_status_ok: "Completed",
      history_status_failed: "Failed",
      history_status_cancelled: "Cancelled",
      history_continue: "Continue task",
      history_not_resumable: "No transcript was saved for this task — it cannot be continued",
      history_delete: "Delete",
      history_clear_all: "Clear all",
      history_clear_confirm: "Clear the whole history?",
      history_loaded_chip: "Loaded",
      history_loaded_notice:
        "A task loaded from the history. Its earlier proposals are read-only — to change anything, continue the task below.",
      history_readonly_hint: "Proposals from the saved task — read-only",
      history_error: "Failed to load the task history: {error}",
      history_unavailable: "Task history is not available in this version",
      history_load_failed: "Failed to load the saved task: {error}",
      save_history_label: "Keep task history on this computer",
      save_history_hint:
        "Tasks are stored in a local file on this computer only, so they can be continued after the app is closed. Unchecked — no history is kept.",
