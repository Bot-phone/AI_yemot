...
- **Windows, בלי התקנה**: הקובץ `-portable.exe` הוא התוכנה כולה בקובץ יחיד. שומרים ומפעילים מכל מקום. דורש את רכיב WebView2 של מיקרוסופט, שקיים כברירת מחדל ב-Windows 10 ו-11.
...
התוכנה בודקת בהפעלה אם יש גרסה חדשה. לחיצה על "עדכון זמין" מורידה ומתקינה אותה (הקובץ נבדק מול חתימה דיגיטלית לפני ההתקנה). אם אין קובץ חתום למערכת שלכם, נפתח דף ההורדה. הגרסה הניידת לא מתקינה עדכונים: הלחיצה מורידה את הקובץ הנייד החדש, ומחליפים איתו את הישן.
